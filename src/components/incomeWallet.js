...
import { transactionsIncomeWalletReport } from "../redux/actions/transaction";
...
const IncomeWallet = () => {
  ...
  const pageCount = Math.ceil(incomeWallet.length / userPerPage);
      ...
      <div className={`${styles.dashboard_content_item} ${styles.padding10}`}>
        <div className={`tableholder ${styles.bordercolor}`}>
          <div className={styles.tableheadertop}>
            Total Income Wallet &nbsp;<label>1243.71</label> <span>MDR</span>
          </div>
          ...
          >
            ...
            >
              ...
              <table>
                ...
                {incomeWallet.length === 0 ? <tr><td>No Records found</td></tr> : '' }
                  {incomeWallet &&
                    incomeWallet
                              ...
                              <div className={styles.titlelabelblock}>
                                <label>
                                  {item.transactionType === "C" ? (
                                    <em className={` ${styles.lightgreen}`}>
                                      {item.amountMDR}
                                    </em>
                                ...
                                <label>
                                  <span>Coin Rate {item.coinRate} USD</span>
                                </label>
                              </div>
                              {item.transactionType === "C" ? (
