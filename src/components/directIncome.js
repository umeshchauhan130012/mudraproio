...
import { transactionsDirectIncomeReport } from '../redux/actions/transaction';
...
const DirectIncome = () => {
    ...
    const pageCount = Math.ceil(directIncome.length / userPerPage);
  ...
  >
    <div className={`tableholder ${styles.bordercolor}`}>
      <div className={styles.tableheadertop}>
        Total Direct Income &nbsp;<label>1243.71</label>{" "}
        <span>MDR</span>
      </div>
        ...
        >
          ...
          <table>
            <tbody>
              ...
              {directIncome.length === 0 ? <tr><td>No Records found</td></tr> : '' }
              {directIncome &&
                directIncome
                  .slice(
                    pagesVisited,
