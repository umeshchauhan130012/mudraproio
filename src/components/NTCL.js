...
import { transactionsNTCLWalletReport } from "../redux/actions/transaction";
...
const NTCL = () => {
  ...
  const pageCount = Math.ceil(ntcl.length / userPerPage);
      ...
      <div className={`${styles.dashboard_content_item} ${styles.padding10}`}>
        <div className={`tableholder ${styles.bordercolor}`}>
          <div className={styles.tableheadertop}>
            Total NTCL Income &nbsp;<label>1243.71</label> <span>MDR</span>
          </div>
          ...
          >
            ...
            >
              ...
              <table>
                ...
                {ntcl.length === 0 ? <tr><td>No Records found</td></tr> : '' }
                  {ntcl &&
                    ntcl
                          ...
                          <td>
                            ...
                            >
                              <div className={styles.titlewidthtabl}>
                                ...
                                <label>
                                  <span>{item.transdate.split("T")[0]}</span>
                                </label>
                              </div>
                            </div>
                          </td>
